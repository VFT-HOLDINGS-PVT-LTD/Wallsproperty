        ...
        <section id="main" class="clearfix ad-details-page">
            <div class="container">
                ...
                <div class="adpost-details">
                    <div class="row">
                        <div class="col-lg-8">
                            <form style="color: #000"  id="frm_data" name="frm_data" action="<?php echo base_url(); ?>Post_Ad/Publish_Post_Elec" method="POST" enctype="multipart/form-data">
                                <fieldset>
...
<!--                                            <label class="col-sm-3 label-title">Brand Name<span class="required">*</span></label>
                                        ...
                                        <!--                                        <div class="row form-group brand-name">
                                                                                    ...
                                                                                    <div class="col-sm-9">
                                                                                        <input type="text" required="" id="txt_model" name="txt_model" class="form-control" placeholder="Ex: S7 Edge">
                                                                                    </div>
                                                                                </div>-->
...
//                                        var_dump($cat_img);
//                                        die;
                                        if (($cat_img[0]->Ad_Cat_ID) == 6 || ($cat_img[0]->Ad_Cat_ID) == 10 || ($cat_img[0]->Ad_Cat_ID) == 11  || ($cat_img[0]->Ad_Cat_ID) == 12) {
                                            $Hide = 'hide';
                                        }
                                        ?>

                                        <div class="<?php echo $Hide; ?> row form-group select-condition">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 imgUp">
                                                        ...
                                                        <label class="btn btn-success">
                                                            Select Image<input type="file" required="" name="img_pro1" id="img_pro1" class="uploadFile img"  style="width: 0px;height: 0px;overflow: hidden;">
                                                        </label>
                                                    </div><!-- col-2 -->
                                        ...
                                        <h6 style="color: #FF0000">* Need to select at least one Image</h6>
