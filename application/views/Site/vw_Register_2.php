                ...
                <div class="row text-center">
                    ...
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                        <div class="user-account">
                            ...
                            <form action="<?php echo base_url(); ?>Register/Register_user" method="POST" id="frm_register" name="frm_register">
                                ...
                                <div class="form-group">
                                    <input type="password" name="txt_password" id="txt_password" required="" class="form-control" placeholder="Password">
                                </div>
                                <div class="form-group">
                                    <input type="password" name="txt_conf_password" id="txt_conf_password" required="" class="form-control" placeholder="Confirm Password">
                                </div>
                                <div class="form-group">
                                    <input type="text" required="" id="txt_mobile" name="txt_mobile" class="form-control" placeholder="Mobile Number">
                                </div>
                                <!-- select -->
                                ...
                                <button type="submit" href="#" class="btn">Registration</button>	<button type="button" id="clear" name="clear" class="btn btn-danger">Clear</button>	
                            </form>
                            <!-- checkbox -->
