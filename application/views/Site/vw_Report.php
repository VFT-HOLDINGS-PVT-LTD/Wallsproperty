                ...
                <div class="row text-center">
                    ...
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                        <div class="user-account">
                            <h2>Report AD</h2>
                            <h4>AD Name : &nbsp;<?php echo $data_ad[0]->Ad_Name ?></h4>
                            
                            <form action="<?php echo base_url(); ?>Home/report" method="POST" id="frm_register" name="frm_register">
                                <select class="form-control" required="" id="txt_r_type" name="txt_r_type">
                                    <option value="" default>-- Select Reason --</option>
                                    <?php foreach ($data_rpt_cat as $t_data) { ?>
                                        <option value="<?php echo $t_data->RPT_TP_ID; ?>" ><?php echo $t_data->RPT_Type_Name; ?></option>
                                ...
                                <input type="text" hidden="" name="txt_ad_code" id="txt_ad_code" value="<?php echo $data_ad[0]->AD_Code ?> ">
