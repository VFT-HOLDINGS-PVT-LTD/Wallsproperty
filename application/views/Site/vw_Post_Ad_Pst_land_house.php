                                        ...
                                        <form style="color: #000" id="frm_data" name="frm_data"
                                            ...
                                            <fieldset>
                                                <div class="section postdetails" style="margin-top: 30px;">
                                                        ...
                                                        <ul class="select-category list-inline">
                                                            ...
                                                            <li class="active">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    name="txt_sub_cat" id="txt_sub_cat" hidden="">
                                                            </li>
                                                            <a class="edit" style="margin-left: 450px;" href="<?php echo base_url(); ?>Post_Ad">
                                                    ...
                                                    <div class="row form-group brand-name">
                                                        ...
                                                        <label class="col-sm-1 label-title">City<span
                                                                class="required" style="color:red;">*</span></label>
                                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" required="" id="txt_brand" name="txt_brand" class="form-control" placeholder="Ex: Samsung">
                                                        ...
                                                        <label class="col-sm-2 label-title">Title<span
                                                                class="required" style="color:red;">*</span></label>
                                                        <div class="col-sm-5">
                                                    ...
                                                    <div class="row form-group brand-name">
                                                        ...
                                                        <label class="col-sm-1 label-title">
                                                            Unit<span class="required" style="color:red;">*</span></label>
                                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" required="" id="txt_brand" name="txt_brand" class="form-control" placeholder="Ex: Samsung">
                                                    ...
                                                    <div class="row form-group select-price">
                                                        ...
                                                        <label class="col-sm-2 label-title">Price<span
                                                                class="required" style="color:red;">*</span></label>
