        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-12">
                <div class="group-icon">
                    <div class="box-icons flex">
                        <div class="images">
                            <img src="<?php echo base_url(); ?>assets/images/icon/footer-icon-1.png" alt="images">
                        </div>
                        <div class="content">
            ...
            <div class="col-lg-6 col-md-12 col-12">
                <div class="group-icon group-2">
                    <div class="box-icons flex">
                        <div class="images">
                            <img src="<?php echo base_url(); ?>assets/images/icon/footer-icon-2.png" alt="images">
                        </div>
                        <div class="content">
                    ...
                    <div class="box-icon flex align-center justify-space">
                        <div class="img-group flex align-center">
                            <div class="images flex-none">
                                <img src="<?php echo base_url();?>assets/images/author/author-footer.jpg" alt="images">
                            </div>
                            <div class="content">
                                <p>Darrell Steward</p>
                        ...
                        <div class="content">
                            ...
                            <a
                                ...
                                <h5 class="fw-4 text-color-8"><span class="__cf_email__"
                                        data-cfemail="623007030e071116031607011222050f030b0e4c010d0f">[email&#160;protected]</span>
                                </h5>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="wrap-logo flex align-center justify-space">
                    <div class="logo-footer style box-1" id="logo-footer">
                        <a href="index.html">
                            <img src="<?php echo base_url(); ?>assets/images/logo/logo-footer%402x.png" alt="img" width="197" height="48">
                        </a>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="title-bottom center"> Copyright © 2023. Designed & Developed by <a
                        href="https://themeforest.net/user/themesflat/portfolio" class="text-color-1">Themesflat.</a>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?php echo base_url(); ?>app/js/jquery.min.js"></script>
...
<script src="<?php echo base_url(); ?>app/js/jquery-validate.js"></script>

<script src="<?php echo base_url(); ?>app/js/jquery.fancybox.js"></script>
