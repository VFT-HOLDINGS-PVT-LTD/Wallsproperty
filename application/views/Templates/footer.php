        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="widget widget-info">
                    ...
                    <h5 class="text-color-1">No.78, Havelock Road, Colombo 05, Srilanka.</h5>
                ...
                <div class="widget widget-menu style-2">
                    ...
                    <div class="box-icon flex align-center">
                        ...
                        <div class="content">
                            <p>Email:</p>
                            <a
                                href="https://themesflat.co/cdn-cgi/l/email-protection#e5b78084898096918491808695a58288848c89cb868a88">
                                <h5 class="fw-4 text-color-8"><span class="__cf_email__"
                                        data-cfemail="623007030e071116031607011222050f030b0e4c010d0f">wallspropertyservice@gmail.com</span>
                                </h5>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="widget widget-menu style-3 ">
                    ...
                    <li><a href="#">Property Management</a></li>
                        <li><a href="#">Letting & Renting</a></li>
                        <li><a href="#">Property Brokering</a></li>
                        <li><a href="#">Legal Assistance</a></li>
                        <li><a href="#">Mortgage & Hosting Loan Assistance</a></li>
                        <li><a href="#">Property Maintance & Renovation</a></li>
                        <li><a href="#">Property Dispute Management</a></li>
                        <!-- <li><a href="#">Escrow Services in Property Transactions</a></li> -->
                        <li><a href="#">Valuation & Land Surveying</a></li>
                        <li><a href="#">Land Sales & Property Development</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <form method="post" class="comment-form form-submit" action="#" accept-charset="utf-8">
                        ...
                        <div class="text-wrap clearfix">
                            <fieldset class="email-wrap style-text">
                                <input type="email" class="tb-my-input" name="email" placeholder="Your email address"
                                    required="">
                            </fieldset>
                        </div>
            ...
            <div class="col-lg-12">
                <div class="wrap-logo flex align-center justify-space">
                    <div class="logo-footer style box-1" id="logo-footer">
                        <a href="index.html">
                            <img src="assets/images/logo/wps.jpeg" alt="img" width="277" height="60">
                        </a>
                    </div>
                    <div class="box-menu box-2">
                        <ul class="menu-bottom flex align-center fs-16 fw-6">
                            ...
                            <li><a href="agents.html">About Us</a> </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="title-bottom center"> Copyright © 2024. Designed & Developed by <a
                        href="https://vftholdings.lk/" class="text-color-1">VFT HOLDINGS (PVT) LTD</a>
                </div>
            </div>
        </div>
    </div>
