<footer id="footer" class="clearfix home2" style="margin-top: 90px;">
	<div class="container">
		<div class="row">
				...
				<div class="group-icon">
					<div class="box-icons flex">
						...
						<div class="content">
							...
							<p class="font-2 text-color-2">Tell us your needs, we will give you thousands of suggestions
								for the dream home.</p>
						</div>
					</div>
				...
				<div class="group-icon">
					<div class="box-icons flex">
						...
						<div class="content">
							...
							<p class="font-2 text-color-2">We will connect you to thousands of people who need to buy a
								home.</p>
						</div>
					</div>
					<div class="button-footer center">
							...
							<svg width="50" height="50" viewBox="0 0 50 50" fill="none"
								...
								<g opacity="0.3">
									<path fill-rule="evenodd" clip-rule="evenodd"
										...
										stroke="#1C1C1E" stroke-miterlimit="22.9256" stroke-linecap="round"
					...
					<div class="box-icon flex align-center">
						<div class="icon flex-none">
							<svg width="50" height="50" viewBox="0 0 50 50" fill="none"
								xmlns="http://www.w3.org/2000/svg">
								<g opacity="0.3">
									<mask id="mask0_2396_13690" style="mask-type:luminance" maskUnits="userSpaceOnUse"
									...
									<g mask="url(#mask0_2396_13690)">
										<path
											...
											stroke="#1C1C1E" stroke-miterlimit="10" stroke-linecap="round"
											stroke-linejoin="round"></path>
										<path
											...
											stroke="#1C1C1E" stroke-miterlimit="10" stroke-linecap="round"
											stroke-linejoin="round"></path>
										<path d="M31.0829 19.7649C31.4425 21.1118 31.2326 22.2836 30.7562 23.4814"
											stroke="#1C1C1E" stroke-miterlimit="10" stroke-linecap="round"
											stroke-linejoin="round"></path>
										<path d="M30.366 11.5664L24.9999 7.11327L19.6339 11.5664" stroke="#1C1C1E"
										...
										<path d="M25 33.0898L37.6173 25.2368V11.5663H12.3828V25.2368L25 33.0898Z"
											stroke="#1C1aboutvideoC1E" stroke-miterlimit="10" stroke-linecap="round"
											stroke-linejoin="round"></path>
			...
			<div class="col-lg-4 col-md-6 col-12">
				<div class="widget widget-menu style-3 ">
					<h3>Our Company</h3>
					<ul class="box-menu">
						<li><a href="#" class="sub-title">Property Management</a></li>
						<li><a href="#" class="sub-title">Letting & Renting</a></li>
						<li><a href="#" class="sub-title">Property Brokering</a></li>
						<li><a href="#" class="sub-title">Legal Assistance</a></li>
						<li><a href="#" class="sub-title">Mortgage & Hosting Loan Assistance</a></li>
						<li><a href="#" class="sub-title">Property Maintance & Renovation</a></li>
						<li><a href="#" class="sub-title">Property Dispute Management</a></li>
						<!-- <li><a href="#">Escrow Services in Property Transactions</a></li> -->
						<li><a href="#" class="sub-title">Valuation & Land Surveying</a></li>
						<li><a href="#" class="sub-title">Land Sales & Property Development</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="col-lg-12">
				<div class="wrap-logo flex align-center justify-space">
					<div class="logo-footer style2 box-1" id="logo-footer">
						<a href="index.html">
							<img src="assets/images/logo/wps.jpeg" alt="" width="297" height="78">
						</a>
					</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="title-bottom center"> Copyright © 2024. Designed &amp; Developed by <a
						href="https://vftholdings.lk/"
						class="text-color-2 fw-5">VFT HOLDINGS (PVT) LTD.</a> </div>
			</div>
		</div>
	</div>
</div>
