						...
						<div class="icon-tell-box flex align-center">
							<div class="icon flex-none">
								<img width="50" height="50" viewBox="0 0 50 50" fill="none"
									src="assets/images/logo/contact.svg" alt="Your SVG Image">
								<g opacity="0.9">
									<path fill-rule="evenodd" clip-rule="evenodd"
										...
										stroke="#12114e" stroke-miterlimit="22.9256" stroke-linecap="round"
								...
								<ul class="flex align-center">
									<li>
										<img width="22" height="22" viewBox="0 0 22 22" fill="none"
											src="assets/images/logo/user.svg" alt="Your SVG Image">
									</li>
									<a href="<?php echo base_url(); ?>Post_Ad">Login</a>
								</ul>
							</div>
							<div class="flat-bt-top sc-btn-top">
								<a class="sc-button" href="<?php echo base_url(); ?>Post_Ad">
...
<header id="header" class="main-header home2 header  header-fixed style-absolute  ">
	...
	<div class="mobile-menu">
		...
		<nav class="menu-box">
			<div class="nav-logo"><a href="index.html"><img src="assets/images/logo/wps.jpeg" alt="" width="197"
						height="48"></a></div>
				...
				<div class="mobi-icon-box">
					...
					<div class="box flex">
						...
						<div class="content fs-13 lh-16">
							Email: <h5><a href="https://themesflat.co/cdn-cgi/l/email-protection" class="__cf_email__"
									data-cfemail="ee9a868b838b9d88828f9aae89838f8782c08d8183">[email&#160;protected]</a>
							</h5>
						</div>
					</div>
				</div>
