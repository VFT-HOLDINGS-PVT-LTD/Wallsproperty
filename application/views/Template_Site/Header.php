    ...
    <nav  class="navbar navbar-default" style="background-color: #e7e7e7;
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>"><img style="width: 130px; height: 30px" class="" src="<?php echo base_url(); ?>assets/Site/images/sellfree.png" alt="Logo"></a>
            </div>
            <!-- /navbar-header -->
...
<?php // }  ?>
                ...
                <a href="<?php echo base_url(); ?>Post_Ad/" class="btn" style="animation-name: anim; 
                   animation-duration: 1s;
                   animation-iteration-count: infinite;
                   animation-direction: alternate;
                   animation-timing-function: linear;
