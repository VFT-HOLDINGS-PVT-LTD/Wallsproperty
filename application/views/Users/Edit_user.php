                                    ...
                                    <div class="user-account ">
                                        ...
                                        <form action="<?php echo base_url('Users/update') ?>" method="POST"
                                            ...
                                            <div class="form-group">
                                                <input type="text" value="<?php echo $email[0]->U_ID ?>" hidden
                                                    id="txt_name" name="u_id" class="form-control">
                                                <label for="username" class="form-label">Username</label>
                                                <input type="text" value="<?php echo $email[0]->Users_Name ?>"
                                                    id="txt_name" name="txt_name" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <!-- <span>Your email will be login Username</span> -->
                                                <label for="email" class="form-label">Email</label>
                                                <input type="email" value="<?php echo $email[0]->Email ?>" id="txt_mail"
                                                    name="txt_mail" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo $email[0]->Phone_No ?>" required=""
                                                    id="txt_mobile" name="txt_mobile" class="form-control">
