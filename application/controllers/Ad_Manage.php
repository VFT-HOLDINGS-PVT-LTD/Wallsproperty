...
//      $result =   $this->Db_model->getfilteredData("DELETE FROM tbl_ads WHERE AD_Code='$ID' ");
        $this->db->delete('tbl_ads', array('AD_Code' => $ID));
        
        
        $this->session->set_flashdata('success_message', 'Ad deleted successfully');

        redirect(base_url() . 'Profile/'); //*********Redirect form
    }
